...
// Source: simple_bank/db/myDb (interfaces: Store)
//
...
// Package mock_myDb is a generated GoMock package.
package mock_myDb

import (
	context "context"
	reflect "reflect"
	myDb "simple_bank/db/myDb"
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 myDb.ListEntriesParams) ([]myDb.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfers(arg0 context.Context, arg1 myDb.ListTransfersParams) ([]myDb.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccount(arg0 context.Context, arg1 myDb.UpdateAccountParams) (myDb.Account, error) {
	m.ctrl.T.Helper()
